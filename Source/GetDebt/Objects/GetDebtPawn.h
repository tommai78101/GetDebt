...
#include "GetDebtPawn.generated.h"
...
UCLASS(config=Game)
class AGetDebtPawn : public AWheeledVehicle
{
	GENERATED_BODY()

	//Spring Arm Component is a parent of CameraComponent.
...
public:
	AGetDebtPawn(const FObjectInitializer& ObjectInitializer);
